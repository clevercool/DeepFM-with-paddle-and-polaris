...
#ifdef PRINTD 
  printf("-----CpuMatrix::copyByRowIndex-----\n"); 
#endif
  size_t height = getHeight();
  size_t width = getWidth();
  CHECK_EQ(b.getWidth(), width);
...
#ifdef PRINTD 
  printf("-----CpuMatrix::accumulateColSum-----\n"); 
#endif
  CHECK_EQ(getWidth(), src.getWidth());
  CHECK_EQ(getHeight(), (size_t)1);
...
void CpuMatrix::upsampleForward(Matrix& input,
                                ...
                                size_t outputW) {
#ifdef PRINTD 
  printf("-----CpuMatrix::upsampleForward-----\n"); 
#endif
  real* inputData = input.getData();
  real* maskData = mask.getData();
  real* outData = data_;
...
void CpuMatrix::upsampleBackward(Matrix& outputGrad,
                                 ...
                                 size_t outputW) {
#ifdef PRINTD 
  printf("-----CpuMatrix::upsampleBackward-----\n"); 
#endif
  real* outputGradData = outputGrad.getData();
  real* maskData = mask.getData();
  real* inputGradData = data_;
...
void CpuMatrix::maxPoolForward(Matrix& inputMat,
                               ...
                               MatrixPtr maskMatP) {
#ifdef PRINTD 
  printf("-----CpuMatrix::maxPoolForward-----\n"); 
#endif
  real* inputData = inputMat.getData();
  real* outData = data_;
  real* maskData = NULL;
...
void CpuMatrix::maxPoolBackward(Matrix& image,
                                ...
                                size_t paddingW) {
#ifdef PRINTD 
  printf("-----CpuMatrix::maxPoolBackward-----\n"); 
#endif
...
void CpuMatrix::avgPoolForward(Matrix& input,
                               ...
                               bool excludeMode) {
#ifdef PRINTD 
  printf("-----CpuMatrix::avgPoolForward-----\n"); 
#endif
  // The main loop
...
void CpuMatrix::avgPoolBackward(Matrix& input,
                                ...
                                bool excludeMode) {
#ifdef PRINTD 
  printf("-----CpuMatrix::avgPoolBackward-----\n"); 
#endif
  size_t num = input.getHeight();
...
void CpuMatrix::maxPool3DForward(Matrix& inputMat,
                                 ...
                                 size_t paddingW) {
#ifdef PRINTD 
  printf("-----CpuMatrix::maxPool3DForward-----\n"); 
#endif
  real* inputData = inputMat.getData();
  real* outData = getData();
  real* maxPoolIdxData = maxPoolIdx.getData();
...
void CpuMatrix::maxPool3DBackward(Matrix& outGrad,
                                  ...
                                  real scaleOutput) {
#ifdef PRINTD 
  printf("-----CpuMatrix::maxPool3DBackward-----\n"); 
#endif
...
void CpuMatrix::avgPool3DForward(Matrix& input,
                                 ...
                                 size_t paddingW) {
#ifdef PRINTD 
  printf("-----CpuMatrix::avgPool3DForward-----\n"); 
#endif
  // The main loop
  size_t num = input.getHeight();
  size_t inLength = imgSizeH * imgSizeW * imgSizeD;
...
void CpuMatrix::avgPool3DBackward(Matrix& input,
                                  ...
                                  real scaleOutput) {
#ifdef PRINTD 
  printf("-----CpuMatrix::avgPool3DBackward-----\n"); 
#endif
  size_t num = input.getHeight();
  size_t inLength = imgSizeH * imgSizeW * imgSizeD;
  size_t outLength = outputH * outputW * outputD;
...
void CpuMatrix::maxSequenceForward(Matrix& input,
                                   ...
                                   IVector& index) {
#ifdef PRINTD 
  printf("-----CpuMatrix::maxSequenceForward-----\n"); 
#endif
...
void CpuMatrix::maxSequenceBackward(Matrix& outputGrad,
                                    ...
                                    IVector& index) {
#ifdef PRINTD 
  printf("-----CpuMatrix::maxSequenceBackward-----\n"); 
#endif
...
#ifdef PRINTD 
  printf("-----CpuMatrix::addSharedBias-----\n"); 
#endif
  CHECK_EQ(b.getHeight(), (size_t)1);
  real* aData = getData();
  real* bData = b.getData();
...
#ifdef PRINTD 
  printf("-----CpuMatrix::collectSharedBias-----\n"); 
#endif
  CHECK_EQ(getHeight(), (size_t)1);
  real* B = getData();
  real* A = a.getData();
...
void CpuMatrix::sequenceAvgForward(Matrix& a,
                                   ...
                                   int mode) {
#ifdef PRINTD 
  printf("-----CpuMatrix::sequenceAvgForward-----\n"); 
#endif
  size_t height = getHeight();
  size_t width = getWidth();
  CHECK_EQ(height, startsPos.getSize() - 1);
...
void CpuMatrix::sequenceAvgBackward(Matrix& a,
                                    ...
                                    int mode) {
#ifdef PRINTD 
  printf("-----CpuMatrix::sequenceAvgBackward-----\n"); 
#endif
  size_t height = a.getHeight();
  size_t width = getWidth();
  CHECK_EQ(height, startsPos.getSize() - 1);
...
#ifdef PRINTD 
  printf("-----CpuMatrix::selectElements-----\n"); 
#endif
...
#ifdef PRINTD 
  printf("-----CpuMatrix::selectRowsImp-----\n"); 
#endif
  CHECK(!table.useGpu());
  CHECK(!ids.useGpu());
  CHECK_EQ(getHeight(), ids.getSize());
...
#ifdef PRINTD 
  printf("-----SharedCpuMatrix::initShared-----\n"); 
#endif
...
#ifdef PRINTD 
  printf("-----SharedCpuMatrix::initBlock-----\n"); 
#endif
...
#ifdef PRINTD 
  printf("-----CpuMatrix::addColumnVector-----\n"); 
#endif
  BaseMatrix::addColVector(const_cast<Matrix&>(b));
}
...
/* this = this* b */
void CpuMatrix::rightMul(Matrix& b) {   
#ifdef PRINTD 
  printf("-----CpuMatrix::rightMul-----\n"); 
#endif
  return rightMul(b, 1.0, 0.0); }

/* this = scaleAB*(a*this) +  scaleT*this */
void CpuMatrix::leftMul(Matrix& a, real scaleAB, real scaleT) {
#ifdef PRINTD 
  printf("-----CpuMatrix::leftMul-----\n"); 
#endif
  (void)a;
  (void)scaleAB;
  (void)scaleT;
...
/* this = a*this) */
void CpuMatrix::leftMul(Matrix& a) {
  
#ifdef PRINTD 
  printf("-----CpuMatrix::leftMul-----\n"); 
#endif
   return leftMul(a, 1.0, 0.0); }

void CpuMatrix::colMerge(Matrix& src) {
  
#ifdef PRINTD 
  printf("-----CpuMatrix::colMerge-----\n"); 
#endif
   src.rowSum(*this); }

void CpuMatrix::rowSum(Matrix& sum) {
#ifdef PRINTD 
  printf("-----CpuMatrix::rowSum-----\n"); 
#endif
  CHECK_EQ(sum.getHeight(), getHeight());
  CHECK_EQ(sum.getWidth(), (size_t)1);
...
void CpuMatrix::maxoutForward(Matrix& a,
                              ...
                              size_t groups) {
#ifdef PRINTD 
  printf("-----CpuMatrix::maxoutForward-----\n"); 
#endif
...
void CpuMatrix::maxoutBackward(Matrix& a,
                               ...
                               size_t groups) {
#ifdef PRINTD 
  printf("-----CpuMatrix::maxoutBackward-----\n"); 
#endif
  CHECK(dynamic_cast<CpuMatrix*>(&a));
  CHECK(dynamic_cast<CpuIVector*>(&id));
  CHECK_EQ(a.getHeight(), getHeight());
...
#ifdef PRINTD 
  printf("-----CpuMatrix::rowNormalizeL1-----\n"); 
#endif
  CHECK(!out.useGpu());
...
void CpuMatrix::classificationError(Matrix& output,
                                    ...
                                    size_t topkSize) {
#ifdef PRINTD 
  printf("-----CpuMatrix::classificationError-----\n"); 
#endif
  size_t numSamples = this->getHeight();
...
#ifdef PRINTD 
  printf("-----CpuMatrix::oneHotCrossEntropy-----\n"); 
#endif
...
#ifdef PRINTD 
  printf("-----CpuMatrix::oneHotCrossEntropyBp-----\n"); 
#endif
  CHECK(dynamic_cast<CpuMatrix*>(&output));
  CHECK(dynamic_cast<CpuIVector*>(&label));
  size_t numSamples = getHeight();
...
void CpuMatrix::oneHotCrossEntropyWithSelfNorm(Matrix& output,
                                               ...
                                               real alpha) {
#ifdef PRINTD 
  printf("-----CpuMatrix::oneHotCrossEntropyWithSelfNorm-----\n"); 
#endif
  CHECK(dynamic_cast<CpuMatrix*>(&output));
  CHECK(dynamic_cast<CpuIVector*>(&label));
...
void CpuMatrix::oneHotCrossEntropyWithSelfNormBp(Matrix& output,
                                                 ...
                                                 real alpha) {
#ifdef PRINTD 
  printf("-----CpuMatrix::oneHotCrossEntropyWithSelfNormBp-----\n"); 
#endif
  CHECK(dynamic_cast<CpuMatrix*>(&output));
  CHECK(dynamic_cast<CpuIVector*>(&label));
  size_t numSamples = getHeight();
...
#ifdef PRINTD 
  printf("-----CpuMatrix::sequenceSoftmax-----\n"); 
#endif
  CHECK_EQ(getWidth(), 1UL);
  CHECK_EQ(output.getWidth(), 1UL);
  CHECK(isContiguous());
...
#ifdef PRINTD 
  printf("-----CpuMatrix::softmaxDerivative-----\n"); 
#endif
...
#ifdef PRINTD 
  printf("-----CpuMatrix::sumOfSquaresBp-----\n"); 
#endif
  CHECK(output.useGpu_ == false && label.useGpu_ == false)
      << "Matrix type are not equal";
...
#ifdef PRINTD 
  printf("-----CpuMatrix::tanhDerivative-----\n"); 
#endif
  BaseMatrix::tanhDerivative(output);
}
...
#ifdef PRINTD 
  printf("-----CpuMatrix::softreluDerivative-----\n"); 
#endif
  CHECK(isContiguous());
  CHECK(output.isContiguous());
  size_t numSamples = getHeight();
...
#ifdef PRINTD 
  printf("-----CpuMatrix::randomizeUniform-----\n"); 
#endif
  CHECK(isContiguous());
  real* data = getData();
...
#ifdef PRINTD 
  printf("-----CpuMatrix::paramReluForward-----\n"); 
#endif
  real* input = data.getData();
  real* w = W.getData();
  real* output = data_;
...
#ifdef PRINTD 
  printf("-----CpuMatrix::paramReluBackwardW-----\n"); 
#endif
  real* ograd = oGrad.getData();
  real* input = data.getData();
  real* wgrad = data_;
...
#ifdef PRINTD 
  printf("-----CpuMatrix::paramReluBackwardDiff-----\n"); 
#endif
  real* diff = data_;
  real* input = data.getData();
  real* ograd = oGrad.getData();
...
#ifdef PRINTD 
  printf("-----CpuMatrix::circularConvDerivative-----\n"); 
#endif
...
#ifdef PRINTD 
  printf("-----CpuMatrix::multiBinaryLabelCrossEntropy-----\n"); 
#endif
  CHECK(dynamic_cast<CpuMatrix*>(&output));
  auto labelPtr = dynamic_cast<CpuSparseMatrix*>(&label);
  CHECK(labelPtr);
...
#ifdef PRINTD 
  printf("-----CpuMatrix::multiBinaryLabelCrossEntropyBp-----\n"); 
#endif
  CHECK(dynamic_cast<CpuMatrix*>(&output));
  auto labelPtr = dynamic_cast<CpuSparseMatrix*>(&label);
  CHECK(labelPtr);
...
void CpuMatrix::classificationErrorMulti(Matrix& output,
                                         ...
                                         real threshold) {
#ifdef PRINTD 
  printf("-----CpuMatrix::classificationErrorMulti-----\n"); 
#endif
  CHECK(dynamic_cast<CpuMatrix*>(&output));
  auto labelPtr = dynamic_cast<CpuSparseMatrix*>(&label);
  CHECK(labelPtr);
...
void CpuMatrix::bilinearForward(const Matrix& in,
                                ...
                                const real ratioW) {
#ifdef PRINTD 
  printf("-----CpuMatrix::bilinearForward-----\n"); 
#endif
...
void CpuMatrix::bilinearBackward(const Matrix& out,
                                 ...
                                 const real ratioW) {
#ifdef PRINTD 
  printf("-----CpuMatrix::bilinearBackward-----\n"); 
#endif
