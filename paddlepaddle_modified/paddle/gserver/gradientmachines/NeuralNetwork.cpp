...
#ifdef PRINTD                              
    std::cout<<"Create layer. Layer name:"<< layer->getName()<<std::endl;
#endif
...
#ifdef PRINTD                                
      printf("gLayerStackTrace.push ------------------------------------------------- \n");
#endif
      gLayerStackTrace.push(layer->getName());
#ifdef PRINTD                              
      printf("layer->forward(passType);  %s------------------------------------------------- \n", layer->getName().c_str());
#endif
      layer->forward(passType);
#ifdef PRINTD                              
      printf("gLayerStackTrace.pop ------------------------------------------------- \n");
#endif
