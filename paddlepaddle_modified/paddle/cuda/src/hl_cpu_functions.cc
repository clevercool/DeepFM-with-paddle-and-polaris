...
real relu(const real a) { 
  printf("real relu(const real a)\n");
    return a > 0.0f ? a : 0.0f; }

real sigmoid(const real a) {
  printf("sigmoid(const real a)\n");
...
real linear(const real a) {   
  printf("real linear(const real a)\n");
  return a; }

real relu(const real a, const real b) {
  
  printf("real relu(const real a, const real b)\n");
   return a * (b > 0.0f ? 1.0f : 0.0f); }

real sigmoid(const real a, const real b) {
  printf("sigmoid(const real a, const real b)\n");
   return a * b * (1 - b); }
